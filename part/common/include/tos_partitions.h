...
#define TOS_TMP_FS_SIZE             0x00001000UL
#define TOS_TMP_STAGE_ADDRESS       (TOS_PART_TMP_ADDRESS + TOS_TMP_FS_SIZE)
#define TOS_TMP_STAGE_SIZE          (TOS_PART_TMP_SIZE - TOS_TMP_FS_SIZE)
...
#define TOS_USERDATA_FS_ADDRESS     (TOS_PART_USERDATA_ADDRESS + TOS_USERDATA_SETTINGS_SIZE)
#define TOS_USERDATA_FS_SIZE        (TOS_PART_USERDATA_SIZE - TOS_USERDATA_SETTINGS_SIZE)
