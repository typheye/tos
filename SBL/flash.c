...
#define SBL_PART_REC_OFFSET    0x00010000UL
#define SBL_PART_REC_SIZE      0x00010000UL
...
static const char sbl_part_name_rec[] SBL_CONST = "rec";
...
static const SBL_FlashPartition sbl_partitions[] SBL_CONST = {
    ...
    {sbl_part_name_rec,    SBL_PART_REC_OFFSET,    SBL_FLASH_BASE + SBL_PART_REC_OFFSET,    SBL_PART_REC_SIZE,    0U, 0U, 1U, 1U},
