...
#define SBL_PART_TRUST_OFFSET  0x00010000UL
#define SBL_PART_TRUST_SIZE    0x00010000UL
...
static const SBL_FlashPartition sbl_partitions[] SBL_CONST = {
    ...
    {"trust",  SBL_PART_TRUST_OFFSET,  SBL_FLASH_BASE + SBL_PART_TRUST_OFFSET,  SBL_PART_TRUST_SIZE,  0U, 0U, 0U, 1U},
    {"sah",    SBL_PART_SAH_OFFSET,    SBL_FLASH_BASE + SBL_PART_SAH_OFFSET,    SBL_PART_SAH_SIZE,    0U, 0U, 1U, 1U},
    {"system", SBL_PART_SYSTEM_OFFSET, SBL_FLASH_BASE + SBL_PART_SYSTEM_OFFSET, SBL_PART_SYSTEM_SIZE, 0U, 1U, 0U, 0U},
};
