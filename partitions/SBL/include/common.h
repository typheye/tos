 ...
 * @file    common.h
 * @author  Typheye
 * @brief   SBL common utilities interface.
 ******************************************************************************
 *
...
#if defined(REC_IMAGE)
#define SBL_CODE  __attribute__((section(".rec.text"), noinline, used))
#define SBL_CONST __attribute__((section(".rec.rodata"), used))
#else
